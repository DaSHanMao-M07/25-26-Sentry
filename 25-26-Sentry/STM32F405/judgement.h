...
public:
	...
	struct {
		...
		struct {
			...
			uint8_t HP_deduction_reason; //0：装甲模块被弹丸攻击导致扣血 1：裁判系统重要模块离线导致扣血 2：射击初速度超限导致扣血 3：枪口热量超限导致扣血 4：底盘功率超限导致扣血 5：装甲模块受到撞击
		...
		struct {
			...
			uint8_t game_progress;//当前比赛阶段 0未开始 1准备阶段 2十五秒裁判系统自检 3五秒倒计时 4比赛中 5比赛结算中
