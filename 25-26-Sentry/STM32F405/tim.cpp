	...
	if (htim==&timer.htim)
	{
		...
		/*if (timer.counter % 1000 == 0)
		{
			if (judgement.data.game_status_t.game_progress == 4)
				judgement.data.game_robot_HP_t.blue_outpost_HP = 1500 - (420 - judgement.data.game_status_t.stage_remain_time) * 30;
			if (judgement.data.game_robot_HP_t.blue_outpost_HP > 1500) judgement.data.game_robot_HP_t.blue_outpost_HP = 0;
		}*/
